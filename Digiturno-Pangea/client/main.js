...
const API_BASE = (() => {
  if (typeof window !== 'undefined' && window.location) {
    ...
    if (o.includes('catalystserverless.com')) return o + '/server/digiturno_pangea_function';
    return 'https://digiturno-pangea-793004668.development.catalystserverless.com/server/digiturno_pangea_function';
  }
  return '/server/digiturno_pangea_function';
})();
...
const AUTH_BASE = (() => {
  ...
  return 'https://digiturno-pangea-793004668.development.catalystserverless.com';
})();
